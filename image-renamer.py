...
# Readme label
readme_label = tk.Label(root, text="❗️ Please read the README before running this program ❗️", font=("TkDefaultFont"))
...
# Run button
button = tk.Button(root, text="  Run it  ", font=("TkDefaultFont"), command=get_path, cursor="hand2")
button.pack(pady=10)
